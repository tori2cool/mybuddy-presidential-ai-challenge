...
export interface BuddyAppearance {
  ...
  skinColor: string;
  // eyeColor: string;
  hairStyle: 'none'  | 'short'  | 'long'  | 'curly'  | 'spiky'  | 'ponytail'  | 'mohawk' | 'pigtails';
  // hairColor: string;
  outfitStyle: 'none' | 'tshirt' | 'hoodie' | 'dress' | 'astronaut';
  // outfitColor: string;
  accessory: 'none' | 'hat' | 'sunglasses' | 'crown' | 'headphones';
  // accessoryColor: string;
  // specialFeature: string;
  // specialFeatureColor: string;
  bodyColor: string;
  facialExpression: 'happy' | 'calm' | 'surprised' | 'silly' | 'sleepy';
